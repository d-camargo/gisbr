...
transup:
	...
	@pylupdate5 $(PLUGINNAME)/provider.py $(PLUGINNAME)/geobr_qgis_plugin.py $(PLUGINNAME)/gui/*.py $(PLUGINNAME)/core/*.py $(PLUGINNAME)/core/*/*.py $(PLUGINNAME)/algorithms/*.py $(PLUGINNAME)/algorithms/*/*.py -ts $(PLUGINNAME)/i18n/gisbr_pt.ts
